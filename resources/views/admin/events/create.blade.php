            ...
            <form action="{{ route('admin.events.store') }}" method="POST">
                ...
                <div class="grid grid-cols-2">
                    <div class="form-group">
                        ...
                        <select name="event_type" class="form-select" required>
                            ...
                            <option value="special" {{ old('event_type') === 'special' ? 'selected' : '' }}>Special</option>
                            <option value="live_show" {{ old('event_type') === 'live_show' ? 'selected' : '' }}>Live Show</option>
                ...
                <div class="grid grid-cols-2">
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="starts_at" class="form-input" value="{{ old('starts_at') }}" required>
                    </div>
