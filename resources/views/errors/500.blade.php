...
<body>
    <div class="background-elements">
        <div class="broken-vinyl" style="top: 20%; left: 10%;"><i class="fas fa-compact-disc"></i></div>
        <div class="broken-vinyl" style="top: 60%; right: 10%; animation-direction: reverse;"><i class="fas fa-compact-disc"></i></div>
        <div class="spark" style="top: 30%; left: 20%; animation-delay: 0s;"></div>
        <div class="spark" style="top: 50%; left: 70%; animation-delay: 0.3s;"></div>
        <div class="spark" style="top: 70%; left: 30%; animation-delay: 0.6s;"></div>
        <div class="spark" style="top: 40%; right: 25%; animation-delay: 0.9s;"></div>
        <div class="spark" style="top: 80%; right: 40%; animation-delay: 1.2s;"></div>
    </div>
